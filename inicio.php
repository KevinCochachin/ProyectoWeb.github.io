...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/inicio.slide.css">
    <link rel="stylesheet" type="text/css" href="/css/inicio.cajas.css">
    <link rel="stylesheet" type="text/css" href="/css/inicio.novedades.tendencias.css">
    <link rel="stylesheet" type="text/css" href="/css/inicio.pie.pagina.css">
    <link rel="stylesheet" type="text/css" href="/js/inicio.cajas.js">
</head>
...
<!---------------------------------- Slider -->
    <div class="contenedor_slide">
        ...
        <input type="radio" id="1" name="imagen_slide" hidden/>
        <input type="radio" id="2" name="imagen_slide" hidden/>
        <input type="radio" id="3" name="imagen_slide" hidden/>
        <input type="radio" id="4" name="imagen_slide" hidden/>
        <input type="radio" id="5" name="imagen_slide" hidden/>
        <input type="radio" id="6" name="imagen_slide" hidden/>

    <!-- Imagenes del Slider -->
        <div class="slide">

            <div class="objeto_slide">
                <img src="/img/inicio/s1.png">
            </div>

            <div class="objeto_slide">
                <img src="/img/inicio/s2.png">
            </div>

            <div class="objeto_slide">
                <img src="/img/inicio/s3.png">
            </div>

            <div class="objeto_slide">
                <img src="/img/inicio/s4.png">
            </div>

            <div class="objeto_slide">
                <img src="/img/inicio/s5.png">
            </div>

            <div class="objeto_slide">
                <img src="/img/inicio/s6.png">
            </div>

        </div>

    <!-- Botones del Slider -->
        <div class="boton_slide">

            <label class="boton_objeto" for="1">
                <img src="/img/inicio/s1.png">
            </label>
            
            <label class="boton_objeto" for="2">
                <img src="/img/inicio/s2.png">
            </label>
            
            <label class="boton_objeto" for="3">
                <img src="/img/inicio/s3.png">
            </label>
            
            <label class="boton_objeto" for="4">
                <img src="/img/inicio/s4.png">
            </label>
            
            <label class="boton_objeto" for="5">
                <img src="/img/inicio/s5.png">
            </label>
            
            <label class="boton_objeto" for="6">
                <img src="/img/inicio/s6.png">
            </label>
...
<!-- ====================================================================================== -->
    ...
    <!-- Sección Novedades y Tendencias -->

    <div class="novedades">
        <h1 class="novedades_titulo">¡Novedades!  </h1>
    </div>
    
    <div class="blackfriday"><img src="/img/inicio/n5.jpeg"></div>
    
        <h1 class="titulo_tarjetas">Tendencias</h1>
...
<div class="card m-4" style="width: 23rem;" >
        ...
        <input name="titulo" type="hidden" id="titulo" value="Air Jordan" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="/img/inicio/t1.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Air Jordan 1</h5>
                        <p>Color: verde/rojo/blanco</p>
                        <p class="card-text">Modelo:  CT0978-201 <br><br> Precio S/.250.00 </p>
...
<div class="card m-4" style="width: 23rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Nike Air Force" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="/img/inicio/t2.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Nike Air Force</h5>
                        <p>Color: blanco/negro</p>
                        <p class="card-text">Modelo: DM0211-100 <br><br> Precio S/.300.00</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-4" style="width: 23rem;">
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="250" />
        <input name="titulo" type="hidden" id="titulo" value="Nike SB Dunk" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="/img/inicio/t3.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Nike SB Dunk</h5>
                        <p>Color: azul/blanco/rojo/verde</p>
                        <p class="card-text">Modeo: CU2012-322 <br><br> Precio S/.250.00</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-5" style="width: 23rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Casa Madison" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="/img/inicio/t5.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Casa Madison</h5>
                        <p>Color: verde</p>
                        <p class="card-text">Modelo: CC0-MD102 <br><br> Precio S/.150.00</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-5" style="width: 23rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Lente Boselli" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="/img/inicio/t8.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Lente Boselli</h5>
                        <p>Material: Bambúr</p>
                        <p class="card-text">Modeo: 1B014 <br> <br> Precio S/.120.00</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
