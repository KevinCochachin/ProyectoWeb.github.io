    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_verano">
            ...
            <div class="ropa_titulo">
                <h2>Polo Mango Corta</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/caballeros_verano/polo.jpg" alt="">
            </div>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Camisa" />
...
<div class="contenedor_verano">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_verano">
            ...
            <div class="ropa_img">
                <img src="/img/caballeros_verano/pantalon.jpg" alt="">
            </div>
        ...
        <div class="contenido_verano">
            ...
            <div class="descripcion_verano">
                ...
                <div class="texto_verano">
                    ...
                    <p><span>Género:</span> Hombre</p>
                    <p><span>Marca:</span> AMC</p>
                    <p><span>Bolsillos</span> 2</p>
                    <p><span>Material Principal:</span> Algodón</p>
                    <p><span>Composición:</span> 70% Algodón - 28% Poliéster - 2% Elastano</p>
                    <p><span>Estilo:</span> Verano</p>
...
<div class="contenedor_verano">
    <div class="contenedor_datos">
        ...
        <div class="ropa_verano">
            ...
            <div class="ropa_img">
                <img src="/img/caballeros_verano/zapatilla.jpg" alt="">
            </div>
        ...
        <div class="contenido_verano">
            ...
            <div class="descripcion_verano">
                ...
                <div class="texto_verano">
                    ...
                    <p><span>Género:</span> Hombre</p>
                    <p><span>Marca:</span> New Balance</p>
