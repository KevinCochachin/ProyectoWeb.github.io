...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
  ...
  <link rel="stylesheet" type="text/css" href="/css/inicio.encabezado.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/caballeros.casual.css">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_casual">
            ...
            <div class="ropa_titulo">
                <h2>Camiseta Mango Corta</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/caballeros_casual/polocas.jpg" alt="">
            </div>
        ...
        <div class="contenido_casual">
            ...
            <div class="descripcion_casual">
                ...
                <div class="texto_casual">
                    ...
                    <p><span>Marca:</span> Gzuck</p>
                    <p><span>Tipo de Cuello:</span> Redondo</p>
                    <p><span>Material Principal:</span> Algodón</p>
                    <p><span>Composición:</span> 100% Algodón</p>
                    <p><span>Estilo:</span> Urbano</p>
                    <p><span>Temporada:</span> Toda la temporada</p>
                    <p><span>Precio:</span> S/.65.00</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Camiseta" />
...
<div class="contenedor_casual">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_casual">
            ...
            <div class="ropa_img">
                <img src="/img/caballeros_casual/pantaloncas.jpg" alt="">
            </div>
        ...
        <div class="contenido_casual">
            ...
            <div class="descripcion_casual">
                ...
                <div class="texto_casual">
                    ...
                    <p><span>Género:</span> Hombre</p>
                    <p><span>Diseño:</span> Liso</p>
                    <p><span>Estilo:</span> Casual/p>
                    <p><span>Modelo:</span> Franela</p>
                    <p><span>Composición:</span> Algodon 100%</p>
                    <p><span>Temporada:</span> Toda la temporada</p>
                    <p><span>Precio:</span> S/.65.00</p>
...
<div class="contenedor_casual">
    <div class="contenedor_datos">
        ...
        <div class="ropa_casual">
            ...
            <div class="ropa_img">
                <img src="/img/caballeros_casual/lentes.jpg.crdownload" alt="">
            </div>
        ...
        <div class="contenido_casual">
            ...
            <div class="descripcion_casual">
                ...
                <div class="texto_casual">
                    ...
                    <p><span>Género:</span> Hombre</p>
                    <p><span>Forma:</span> Ovalada</p>
                    <p><span>Estilo:</span> Casual</p>
                    <p><span>Hecho en:</span> Estados Unidos</p>
                    <p><span>Material:</span> Plástico</p>
                    <p><span>Garantía:</span> 6 mese</p>
                    <p><span>Precio:</span> S/.65.00</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="65" />
        <input name="titulo" type="hidden" id="titulo" value="Lentes" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
                <div class="card-body">
