...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/damas.formal.css">
...
<div class="contenedor_formal">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_formal">
            ...
            <div class="ropa_img">
                <img src="/img/damas_formal/saco.jpg" alt="">
            </div>
        ...
        <div class="contenido_formal">
            ...
            <div class="descripcion_formal">
                ...
                <div class="texto_formal">
                    ...
                    <p><span>Marca:</span> Basement</p>
                    <p><span>Modelo:</span> BSCBZB334</p>
                    <p><span>Tipo:</span> Blazers</p>
                    <p><span>Material Principal:</span> Poliéster</p>
                    <p><span>Composición:</span> 100% Poliéster</p>
                    <p><span>Largo de mangas:</span> Manga larga</p>
                    <p><span>Temporada:</span> Toda temporada</p>
                    <p><span>Precio:</span> S/.120.00</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Saco" />
...
<div class="contenedor_formal">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_formal">
            ...
            <div class="ropa_titulo">
                <h2>Blusa Manga Larga</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/damas_formal/polo.jpg" alt="">
            </div>
        ...
        <div class="contenido_formal">
            ...
            <div class="descripcion_formal">
                ...
                <div class="texto_formal">
                    ...
                    <p><span>Género:</span> Mujer</p>
                    <p><span>Marca:</span> Sybilla</p>
                    <p><span>Modelo:</span> SP2BLS702YL</p>
                    <p><span>Tipo:</span> Blusas</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="120" />
        <input name="titulo" type="hidden" id="titulo" value="Blusa" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
                <div class="card-body">
...
<div class="contenedor_formal">
    <div class="contenedor_datos">
        ...
        <div class="ropa_formal">
            ...
            <div class="ropa_titulo">
                <h2>Pantalon Marquis</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/damas_formal/pantalon.jpg" alt="">
            </div>
        ...
        <div class="contenido_formal">
            ...
            <div class="descripcion_formal">
                ...
                <div class="texto_formal">
                    ...
                    <p><span>Género:</span> Mujer</p>
                    <p><span>Material principal:</span> Poliéster</p>
                    <p><span>Composición:</span> 97% Poliester - 3% Spandex</p>
                    <p><span>Estilo:</span> Formal</p>
                    <p><span>Fit:</span> Slim</p>
                    <p><span>Tiro:</span> Alto</p>
