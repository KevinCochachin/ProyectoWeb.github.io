...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
  ...
  <link rel="stylesheet" type="text/css" href="/css/inicio.encabezado.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/caballeros_urbano.css">
...
<div class="contenedor_urbano">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_urbana">

            <div class="ropa_titulo">
                <h2>Polo Mangan Corta</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/caballeros_urbano/polourb.jpg" alt="">
            </div>
    
        </div>
    
        <div class="contenido_urbana">
    
            <div class="tallas_urbana">
            ...
            <div class="descripcion_urbana">

                <div class="descripcion_titulo">
                    <h2>Descripción del producto</h2>
                </div>

                <div class="texto_urbana">
...
<div class="contenedor_urbana">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_urbana">
            ...
            <div class="ropa_img">
                <img src="/img/caballeros_urbano/pantalonurb.jpg" alt="">
            </div>
        ...
        <div class="contenido_urbana">
            ...
            <div class="descripcion_urbana">
                ...
                <div class="texto_urbana">
                    ...
                    <p><span>Género:</span> Hombre</p>
                    <p><span>Marca:</span> Bearcliff</p>
                    <p><span>Bolsillos:</span> 5</p>
                    <p><span>Material Principal:</span> Algodón</p>
    ...
    <div class="contenedor_urbana">
        ...
        <div class="contenedor_datos">
            ...
            <div class="ropa_urbana">
                ...
                <div class="ropa_img">
                    <img src="/img/caballeros_urbano/zapatillasurb.jpg" alt="">
                </div>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="80" />
        <input name="titulo" type="hidden" id="titulo" value="Zapatillas" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
                <div class="card-body">
