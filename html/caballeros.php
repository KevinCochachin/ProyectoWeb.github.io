...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
 ...
 <link rel="stylesheet" type="text/css" href="/css/inicio.encabezado.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/servicios.caballeros.css">
...
<!-- ==================================================================================== -->
    ...
    <div class="contenedor_caballeros">

        <div class="titulo_caballeros">
            <h1>Sección Caballeros</h1>
        </div>

        <div class="titulo_ropa">

            <!-- Tipos de Ropa para Caballeros-->

            <ul>

                <li>
                    <div class="tipo_ropa">
                        <a href="/html/caballeros.formal.php"><h2>Formal</h2></a>
                    </div>

                    <div class="imagen_tipo">
                        <map name=""></map>
                        <img src="/img/servicios_caballeros/formal.png" alt="">
                    </div>
                </li>

                <li>
                    <div class="tipo_ropa">
                        <a href="/html/caballeros.urbano.php"><h2>Urbano</h2></a>
                    </div>

                    <div class="imagen_tipo">
                        <map name=""></map>
                        <img src="/img/servicios_caballeros/urbano.png" alt="">
                    </div>
                </li>
                
                <li>
                    <div class="tipo_ropa">
                        <a href="/html/caballeros.casual.php"><h2>Casual</h2></a>
                    </div>

                    <div class="imagen_tipo">
                        <map name=""></map>
                        <img src="/img/servicios_caballeros/casual.png" alt="">
                    </div>
                </li>

                <li>
                    <div class="tipo_ropa">
                        <a href="/html/caballeros.verano.php"><h2>Verano</h2></a>
                    </div>

                    <div class="imagen_tipo">
                        <map name=""></map>
                        <img src="/img/servicios_caballeros/verano.png" alt="">
                    </div>
                </li>
