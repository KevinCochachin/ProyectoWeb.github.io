...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
 ...
 <link rel="stylesheet" type="text/css" href="/css/inicio.encabezado.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/damas.urbano.css">
...
<div class="contenedor_urbano">

    <div class="titulo_urbano">
        <h1>Urbano:Damas</h1>
    </div>
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_urbano">

            <div class="ropa_titulo">
                <h2>Polo Manga Corta</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/damas_urbano/polo.jpg" alt="">
            </div>
    
        </div>
    
        <div class="contenido_urbano">
    
            <div class="tallas_urbano">
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <input name="precio" type="hidden" id="precio" value="55" />
        <input name="titulo" type="hidden" id="titulo" value="Polo" />
...
<div class="contenedor_urbano">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_urbano">
            ...
            <div class="ropa_img">
                <img src="/img/damas_urbano/pantalon.jpg" alt="">
            </div>
        ...
        <div class="contenido_urbano">
            ...
            <div class="descripcion_urbano">
                ...
                <div class="texto_urbano">
                    ...
                    <p><span>Género:</span> Mujer</p>
                    <p><span>Marca:</span> Forcaps</p>
                    <p><span>Bolsillos:</span> 4</p>
                    <p><span>Material:</span> Algodón</p>
                    <p><span>Composición:</span> 73% Algodón - 25% Poliéster - 2% Elastano</p>
                    <p><span>Estilo:</span> Urbano</p>
                    <p><span>Temporada:</span> Toda la Temporada</p>
                    <p><span>Precio:</span> S/.55</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="55" />
        <input name="titulo" type="hidden" id="titulo" value="Jean" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
                <div class="card-body">
...
<div class="contenedor_urbano">
    <div class="contenedor_datos">
        ...
        <div class="ropa_urbano">
            ...
            <div class="ropa_img">
                <img src="/img/damas_urbano/zapatilla.jpg" alt="">
            </div>
