...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
   ...
   <link rel="stylesheet" type="text/css" href="/css/inicio.encabezado.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/servicios.damas.css">
...
<!-- ==================================================================================== -->
    ...
    <div class="contenedor_damas">

        <div class="titulo_damas">
            <h1>Sección Damas</h1>
        </div>

        <div class="titulo_ropa_m">

            <!-- Tipos de Ropa para Damas-->

            <ul>

                <li>
                    <div class="tipo_ropa_m">
                        <a href="/html/damas.formal.php"><h2>Formal</h2></a>
                    </div>

                    <div class="imagen_tipo_m">
                        <map name=""></map>
                        <img src="/img/servicios_damas/formal.png" alt="">
                    </div>
                </li>

                <li>
                    <div class="tipo_ropa_m">
                        <a href="/html/damas.urbano.php"><h2>Urbano</h2></a>
                    </div>

                    <div class="imagen_tipo_m">
                        <map name=""></map>
                        <img src="/img/servicios_damas/urbano.png" alt="">
                    </div>
                </li>
                
                <li>
                    <div class="tipo_ropa_m">
                        <a href="/html/damas.casual.php"><h2>Casual</h2></a>
                    </div>

                    <div class="imagen_tipo_m">
                        <map name=""></map>
                        <img src="/img/servicios_damas/casual.png" alt="">
                    </div>
                </li>

                <li>
                    <div class="tipo_ropa_m">
                        <a href="/html/damas.verano.php"><h2>Verano</h2></a>
                    </div>

                    <div class="imagen_tipo_m">
                        <map name=""></map>
                        <img src="/img/servicios_damas/verano.png" alt="">
                    </div>
                </li>
