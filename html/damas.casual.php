...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.2/css/all.css">
   ...
   <link rel="stylesheet" type="text/css" href="/css/inicio.encabezado.css">
    ...
    <link rel="stylesheet" type="text/css" href="/css/damas.casual.css">
...
<div class="contenedor_casual">

    <div class="titulo_casual">
        <h1>Casual:Damas</h1>
    </div>
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_casual">
            ...
            <div class="ropa_img">
                <img src="/img/damas_casual/polo.jpg" alt="">
            </div>
    
        </div>
    
        <div class="contenido_casual">
    
            <div class="tallas_casual">
            ...
            <div class="descripcion_casual">

                <div class="descripcion_titulo">
                    <h2>Descripción del producto</h2>
                </div>

                <div class="texto_casual">

                    <p><span>Género:</span> Mujer</p>
                    <p><span>Estilo:</span> Casual</p>
                    <p><span>Temporada:</span> Otoño - Invierno</p>
                    <p><span>Modelo:</span> Fit</p>
                    <p><span>Material:</span> Cuero</p>
                    <p><span>Tipo de mangas:</span> Manga larga</p>
                    <p><span>Precio:</span> S/.80.00</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <input name="titulo" type="hidden" id="titulo" value="Chaqueta " />
...
<div class="contenedor_casual">
    ...
    <div class="contenedor_datos">
        ...
        <div class="ropa_casual">
            ...
            <div class="ropa_titulo">
                <h2>Pantalon Suelto</h2>
            </div>
    
            <div class="ropa_img">
                <img src="/img/damas_casual/pantalon.jpeg" alt="">
            </div>
        ...
        <div class="contenido_casual">
            ...
            <div class="descripcion_casual">
                ...
                <div class="texto_casual">
                    ...
                    <p><span>Género:</span> Mujer</p>
                    <p><span>Estilo:</span> AMC</p>
                    <p><span>Temporada:</span> Primavera - Verano</p>
                    <p><span>Modelo:</span> Slim</p>
                    <p><span>Composición:</span> 54% Algodón - 46% Poliéster</p>
                    <p><span>Echo en:</span> China</p>
                    <p><span>Precio:</span> S/.80.00</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="80" />
        <input name="titulo" type="hidden" id="titulo" value="Pantalon " />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
                <div class="card-body">
...
<div class="contenedor_casual">
    <div class="contenedor_datos">
        ...
        <div class="ropa_casual">
            ...
            <div class="ropa_img">
                <img src="/img/damas_casual/zapatilla.png" alt="">
            </div>
        ...
        <div class="contenido_casual">
            ...
            <div class="descripcion_casual">
                ...
                <div class="texto_casual">
                    ...
                    <p><span>Género:</span> Mujer</p>
                    <p><span>Estilo:</span> Casual</p>
                    <p><span>Material de suela:</span> Goma</p>
                    <p><span>Material principal:</span> Tela</p>
                    <p><span>Composición:</span> Textil - Sintético</p>
                    <p><span>Hecho en:</span> Vietnam</p>
                    <p><span>Tipo de caña:</span> Baja</p>
                    <p><span>Precio:</span> S/.80.00</p>
...
<div class="card m-4" style="width: 10rem; ">
        ...
        <form id="formulario" name="formulario" method="post" action="/cart.php">
        <input name="precio" type="hidden" id="precio" value="80" />
        <input name="titulo" type="hidden" id="titulo" value="Zapatilla " />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
                <div class="card-body">
